...
```{r}
ggplot(data = x, aes(x = mean_age)) + geom_histogram(bins = 20, color = "powderblue", fill = "navy") + xlim(30, 50) + labs(title = "Mean Age of Kenyan Voters", x = "Mean Age", y = "Number of Voters")
```
...
```{r}
ggplot(data = x, aes(x = reg_inc)) + geom_histogram(bins = 30, color = "powderblue") + scale_x_log10()
```
